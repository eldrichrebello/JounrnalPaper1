...
Listed below are some of the challenges faced with implementing and testing our real-time implementation of the Phasor-POD algorithm. Solutions are proposed where possible and works subsequent to this are cited where applicable. It is not our aim to provide solutions for nor to examine every challenge in detail.
